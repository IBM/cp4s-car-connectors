...
class TestAssetServer(unittest.TestCase):
    ...
    def test_connection(self, mock_query_hosts, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.__init__')
    @patch('falconpy.discover.Discover.query_hosts')
    def test_connection_with_error(self, mock_query_hosts, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.query_hosts')
    def test_get_hosts(self, mock_query_hosts, mock_get_hosts, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.get_hosts')
    @patch('falconpy.discover.Discover.query_hosts')
    def test_get_hosts_with_error(self, mock_query_hosts, mock_get_hosts, mock_Discover):
        """unit test for get_hosts"""
        error_response = None
        try:
            full_import_obj = full_import_initialization()
    ...
    def test_get_applications(self, mock_query_apps, mock_get_apps, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.get_applications')
    @patch('falconpy.discover.Discover.query_applications')
    def test_get_applications_with_error(self, mock_query_apps, mock_get_apps, mock_Discover):
    ...
    def test_get_accounts(self, mock_query_accounts, mock_get_accounts, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.get_accounts')
    @patch('falconpy.discover.Discover.query_accounts')
    def test_get_accounts_with_error(self, mock_query_accounts, mock_get_accounts, mock_Discover):
    ...
    def test_get_logins(self, mock_query_logins, mock_get_logins, mock_Discover):
    ...
    @patch('falconpy.discover.Discover.get_logins')
    @patch('falconpy.discover.Discover.query_logins')
    def test_get_logins_with_error(self, mock_query_logins, mock_get_logins, mock_Discover):
    ...
    def test_get_vulnerabilities(self, mock_query_combine_vuln, mock_SpotlightVulnerabilities):
    ...
    @patch('falconpy.spotlight_vulnerabilities.SpotlightVulnerabilities.__init__')
    @patch('falconpy.spotlight_vulnerabilities.SpotlightVulnerabilities.query_vulnerabilities_combined')
    def test_get_vulnerabilities_error(self, mock_query_combine_vuln, mock_SpotlightVulnerabilities):
