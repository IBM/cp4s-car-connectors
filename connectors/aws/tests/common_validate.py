...
def context_patch():
    ...
    context_args = {
        ...
        'debug': False,
        'CONFIGURATION_AUTH_ACCOUNT_ID': 'account-123',
        'CONFIGURATION_AUTH_AWS_ACCESS_KEY_ID': 'xyz123',
        'CONFIGURATION_AUTH_AWS_SECRET_ACCESS_KEY': 'abcxyz',
        'CONNECTION_REGION': "us-east-1",
